...
public class Plane
{
    ...
    private LandingGear landingGear; //tren de aterrizaje
    ...
    // /**
     ...
     // * @param xSpeed Velocidad de la coordenada x en el plano.
     // * @param ySpeed Velocidad de la coordenada y en el plano.
     // * @param landingGear Tren de aterrizaje
     // */
    // public Plane(Person pilot, char identifier, int fuel, int xPos, int yPos, int xSpeed, int ySpeed, LandingGear lg)
    // {
        // this(pilot,identifier,fuel,xPos,yPos,xSpeed,ySpeed);
        // this.setLandingGear(lg);
    // }
    ...
    /**
     * Permite modificar el tren de aterrizaje
     * @param landingGear
     */
    private void setLandingGear(LandingGear landingGear)
    {
        checkParam(landingGear!=null,"El tren de aterrizaje no puede ser null");
    ...
    /**
     * Devuelve el tren de aterrizaje
     * @return Tren de aterrizaje (LandingGear)
     */
