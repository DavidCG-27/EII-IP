...
public class Person
{
    ...
    /**
     * Representa el descuento a los menores de 12 años.
     */
    public final static int CHILD_DISCOUNT=15;
    /**
     * Representa el descuento a los adolescentes (menores de 18).
     */
    public final static int TEEN_DISCOUNT=5;
    /**
     * Representa el descuento a los adultos.
     */
    public final static int ADULT_DISCOUNT=0;
    /**
     * Representa el descuento a los jubilados.
     */
    public final static int RETIRED_DISCOUNT=10;
    /**
     * Representa la edad para el descuento CHILD_DISCOUNT.
     */
    public final static int CHILD_AGE=12;
    /**
     * Representa la edad máxima de un hombre para ser piloto.
     */
    public final static int MAX_MEN_AGE=50;
    /**
     * Representa la edad mínima de un hombre para ser piloto.
     */
    public final static int MIN_MEN_AGE=30;
    ...
    * @return Años según la condición expuesta
    ...
    /**
     * Devuelve el porcentaje de descuento según la edad que tengas.
     * @return Porcentaje de descuento
     */
    public int getDiscount(){
    if (this.getAge()>=ADULTHOOD_AGE && this.getAge()<RETIREMENT_AGE){
        return ADULT_DISCOUNT; 
    }
    else if (this.getAge()>=RETIREMENT_AGE){
        ...
        return TEEN_DISCOUNT;    
    }
    }
    /**
     * Condiciones necesarias para ser piloto (hombre, entre 30 y 50 años ó mujer adulta)
     * @return Puede ser piloto o no
     */
    public boolean canBePilot(){
    if (this.getGender()==GENDER_FEMALE && this.getAge()>=ADULTHOOD_AGE && this.getAge()<RETIREMENT_AGE){
        return true;        
    }
    else if(this.getGender()==GENDER_MALE && this.getAge()>=MIN_MEN_AGE && this.getAge()<=MAX_MEN_AGE){
        return true;
    }
    else{
        return false;
