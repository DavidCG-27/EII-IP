...
public class Person
{
    ...
    /**
     * Array con nombres de mujeres
     */
    private final static String femaleNames[] = {"Laura","María","Patricia","Manuela","Paula"};
    /**
     * Array con nombres de hombres
     */
    private final static String maleNames[] = {"Paco","Miguel","Arturo","Manuel","Gonzalo"};
    /**
     * Array con apellidos
     */
    private final static String surnames[] = {"González","Gómez","Santos","Cuesta","García","Echenique"};
    ...
    public Person()
    {
       ...
       this.setName(getGender()==true?maleNames[r.nextInt(maleNames.length)]:femaleNames[r.nextInt(femaleNames.length)]);
       this.setSurname(surnames[r.nextInt(surnames.length)]);
