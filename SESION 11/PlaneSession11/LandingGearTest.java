...
public class LandingGearTest
{
    ...
    {
        WheelStrut left=new WheelStrut(2);
        WheelStrut right=new WheelStrut(4);
    ...
    {
        WheelStrut left=new WheelStrut(2);
        WheelStrut nose=new WheelStrut(4);
    ...
    public void testLeftStrutFalse1()
    {
        ...
        lg.getLeft().getWheel(1).changePressure(0); //Desinflo la rueda izqd del puntal izqd
    ...
    public void testRightStrutFalse1()
    {
        ...
        lg.getRight().getWheel(1).changePressure(0);
    ...
    public void testNoseStrutFalse1()
    {
        ...
        lg.getNose().getWheel(1).changePressure(0);
    ...
    public void toStringTestFailureLeft()
    {
        ...
        lg.getLeft().getWheel(1).changePressure(0);
